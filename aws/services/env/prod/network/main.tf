module "vpc" {
  #source = "git::https://github.com/UCLALibrary/terraform-aws-vpc.git"
  source = "/Users/avuong/github/terraform-aws-vpc"
  ...
  rancher_eks_subnets = var.eks_rancher_subnets

  ### Public subnets that route through NAT when traversing to NAT destination
  private_subnets = var.private_subnets
  private_prod_lambda_subnets = var.prod_lambda_subnets
  private_test_lambda_subnets = var.test_lambda_subnets
